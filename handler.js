/**
   * Create By Hafidz Abdillah
   * Contact Me on wa.me/628895656884
   * Follow https://instagram.com/hafidzabdillh_
*/
...
break
		...
		let { webp2mp4File } = require('./lib/uploader')
            ...
            let { toAudio } = require('./lib/converter')
            let audio = await toAudio(media, 'mp4')
            kagura.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Convert By Abdillah Botz.mp3`}, { quoted : m })
            }
            break
...
⭔ Url : ${anu.url}`,
	    ...
	    case 'ytmp3': case 'ytaudio': {
            ...
            axios
                .get(`https://api.lolhuman.xyz/api/ytaudio2?apikey=${apikey}&url=${text}`)
                .then(({ data }) => {
...
// TEXTPROME
		...
		if (!isPremium && global.db.data.users[m.sender].limit < 1) return m.reply('Limit Harian Anda Telah Habis')
		    ...
		    db.data.users[m.sender].limit -= 1
                    ...
                    kagura.sendMedia(m.chat, anu.photo_profile, '', `⭔ Full Name : ${anu.fullname}\n⭔ User Name : ${anu.username}\n⭔ Followers : ${anu.followers}\n⭔ Following : ${anu.following}\n⭔ Bio : ${anu.bio}`, m)
		    db.data.users[m.sender].limit -= 1
